            ...
            slides: [
              {
                ...
                loop: false,
                files: [
                  sermon.videoType + ":" + sermon.videoData
                ]
              }
            ],
          }
...
// @httpGet("/public/subtitles")
// public async getAutoGeneratedSubtitles(req: express.Request<{}, {}, null>, res: express.Response): Promise<any> {
//   return this.actionWrapperAnon(req, res, async () => {
//     try {
//       const result = await YouTubeHelper.fetchAutoGeneratedSubtitles("S0ul28VRWwU");
...
// public async getAutoGeneratedSubtitles(req: express.Request<{}, {}, null>, res: express.Response): Promise<any> {
//   return this.actionWrapperAnon(req, res, async () => {
//     const result = await YouTubeHelper.fetchAutoGeneratedSubtitles("S0ul28VRWwU"); dwAQJMnAwnc
//     console.log("result: ", result);
//     // console.log("api: ", Environment.openRouterApiKey)
//     const ai = await OpenAiHelper.initialize();
//     const posts = await OpenAiHelper.generateSocialMediaPosts(result);
//   })
// }
