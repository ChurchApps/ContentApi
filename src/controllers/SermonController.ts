...
export class SermonController extends ContentBaseController {
  ...
  @httpGet("/public/tvWrapper")
  public async getTvWrapper(req: express.Request<{}, {}, null>, res: express.Response): Promise<any> {
    return this.actionWrapper(req, res, async (au) => {
      const churchId = "Hchi650pfrH";
      const result = {
        treeLabels: ["Content"],
        categories: [
          {
            ...
            childrenApi: "https://contentapi.churchapps.org/public/sermons/tvFeed/" + churchId
          },
          {
            id: "lessons",
            name: "Lessons",
