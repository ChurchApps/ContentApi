...
export class BibleTranslationRepository {
  ...
  private async create(translation: BibleTranslation) {
    ...
    const params = [translation.id, translation.abbreviation, translation.name, translation.nameLocal, translation.description, translation.source, translation.sourceKey, translation.language, translation.countries, translation.copyright, translation.attributionRequired, translation.attributionString];
  ...
  private async update(translation: BibleTranslation) {
    ...
    const params = [translation.abbreviation, translation.name, translation.nameLocal, translation.description, translation.source, translation.sourceKey, translation.language, translation.countries, translation.copyright, translation.attributionRequired, translation.attributionString, translation.id];
    await DB.query(sql, params);
    return translation;
  }
